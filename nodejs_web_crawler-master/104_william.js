...
async function search(){
    ...
    //輸入關鍵字，選擇地區，再按下搜尋
    await nightmare
    .goto('https://www.104.com.tw', headers) // 进度到当前网址，所以如果想返回，也可以只有.goto()
...
async function scrollPage(){
    ...
    while(offset <= currentHeight){
        currentHeight = await nightmare.evaluate(() => { //evaluate() 抓 return 返回的值放到 currentHeight 中
...
try {
    asyncArray([
        ...
        await writeFile(`downloads/104_william.json`, JSON.stringify(arrLink, null, 4));
